...
import "./chunk-6JWZA3E7.js";
import "./chunk-AX4EDVAE.js";
import "./chunk-S7HWTF63.js";
import {
  Rating_default
} from "./chunk-AFIODR3A.js";
import "./chunk-XYW2ZP6K.js";
import "./chunk-TJ4WWSAQ.js";
import "./chunk-MDVJZTAK.js";
import {
  Autocomplete_default
} from "./chunk-ZSNIZ2QB.js";
import "./chunk-U6EJWXU5.js";
import "./chunk-SWYYPSSB.js";
import "./chunk-HQDCXEBU.js";
import "./chunk-PEP367D4.js";
import "./chunk-GUZI2PNI.js";
import "./chunk-4GTCBQDQ.js";
...
import "./chunk-RNGCAYUN.js";
import "./chunk-TABFPM3B.js";
import {
  LoadingButton_default,
  getLoadingButtonUtilityClass,
  loadingButtonClasses_default
} from "./chunk-DFXG2KID.js";
import "./chunk-EOWASAE7.js";
import "./chunk-JAP6IMET.js";
import "./chunk-X33WQGRI.js";
...
} from "./chunk-TU5SPZLC.js";
import "./chunk-UVLGNMKT.js";
...
var TreeViewContext = React40.createContext({
  registerNode: () => {
  },
  unregisterNode: () => {
  },
...
var DescendantContext = React41.createContext({});
if (true) {
...
function useDescendant(descendant) {
  const [, forceUpdate] = React41.useState();
  const {
    registerDescendant = noop,
    unregisterDescendant = noop,
    descendants = [],
    parentId = null
  } = React41.useContext(DescendantContext);
...
function DescendantProvider(props) {
  ...
  const [items, set] = React41.useState([]);
  const registerDescendant = React41.useCallback((_ref) => {
    let {
      element
  ...
  const unregisterDescendant = React41.useCallback((element) => {
  ...
  return (0, import_jsx_runtime17.jsx)(DescendantContext.Provider, {
    value,
    children
  });
}
...
function useTreeItem(nodeId) {
  const {
    ...
    selectRange,
    toggleExpansion
  } = React42.useContext(TreeViewContext);
...
var _excluded4 = ["classes", "className", "displayIcon", "expansionIcon", "icon", "label", "nodeId", "onClick", "onMouseDown"];
var TreeItemContent = React43.forwardRef(function TreeItemContent2(props, ref) {
  const {
    classes,
    className,
    displayIcon,
  ...
  return (
    ...
    (0, import_jsx_runtime19.jsxs)("div", _extends({}, other, {
...
true ? TreeItemContent.propTypes = {
   ...
   * The id of the node.
   */
  nodeId: import_prop_types5.default.string.isRequired
} : void 0;
...
var _excluded5 = ["children", "className", "collapseIcon", "ContentComponent", "ContentProps", "endIcon", "expandIcon", "disabled", "icon", "id", "label", "nodeId", "onClick", "onMouseDown", "TransitionComponent", "TransitionProps"];
...
var TreeItem = React44.forwardRef(function TreeItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTreeItem"
  });
  ...
  const {
    ...
    unregisterNode,
    treeId
  } = React44.useContext(TreeViewContext);
  let id;
  if (idProp != null) {
    id = idProp;
  ...
  const [treeItemElement, setTreeItemElement] = React44.useState(null);
  const contentRef = React44.useRef(null);
  const handleRef = useForkRef(setTreeItemElement, ref);
  const descendant = React44.useMemo(() => ({
  ...
  return (0, import_jsx_runtime21.jsxs)(TreeItemRoot, _extends({
    className: clsx_default(classes.root, className),
    role: "treeitem",
    ...
    onFocus: handleFocus,
    ref: handleRef,
    children: [(0, import_jsx_runtime20.jsx)(StyledTreeItemContent, _extends({
      as: ContentComponent,
      ref: contentRef,
      classes: {
      ...
      displayIcon,
      ownerState
    }, ContentProps)), children && (0, import_jsx_runtime20.jsx)(DescendantProvider, {
      id: nodeId,
      children: (0, import_jsx_runtime20.jsx)(TreeItemGroup, _extends({
...
true ? TreeItem.propTypes = {
   ...
   */
  collapseIcon: import_prop_types6.default.node,
  /**
...
var TreeItem3 = React45.forwardRef(function DeprecatedTreeItem(props, ref) {
  warn24();
  return (0, import_jsx_runtime22.jsx)(TreeItem, _extends({}, props, {
    ref
  }));
});
...
var _excluded6 = ["children", "className", "defaultCollapseIcon", "defaultEndIcon", "defaultExpanded", "defaultExpandIcon", "defaultParentIcon", "defaultSelected", "disabledItemsFocusable", "disableSelection", "expanded", "id", "multiSelect", "onBlur", "onFocus", "onKeyDown", "onNodeFocus", "onNodeSelect", "onNodeToggle", "selected"];
...
var TreeView = React46.forwardRef(function TreeView2(inProps, ref) {
  ...
  const isExpanded = React46.useCallback((nodeId) => Array.isArray(expanded) ? expanded.indexOf(nodeId) !== -1 : false, [expanded]);
  const isExpandable = React46.useCallback((nodeId) => nodeMap.current[nodeId] && nodeMap.current[nodeId].expandable, []);
  const isSelected = React46.useCallback((nodeId) => Array.isArray(selected) ? selected.indexOf(nodeId) !== -1 : selected === nodeId, [selected]);
  const isDisabled = React46.useCallback((nodeId) => {
    if (nodeId == null) {
      return false;
    }
  ...
  const unregisterNode = React46.useCallback((nodeId) => {
  ...
  const mapFirstChar = React46.useCallback((nodeId, firstChar) => {
    firstCharMap.current[nodeId] = firstChar;
  }, []);
  const unMapFirstChar = React46.useCallback((nodeId) => {
  ...
  return (0, import_jsx_runtime23.jsx)(TreeViewContext.Provider, {
    ...
    children: (0, import_jsx_runtime23.jsx)(DescendantProvider, {
      children: (0, import_jsx_runtime23.jsx)(TreeViewRoot, _extends({
        role: "tree",
        id: treeId,
...
var TreeView3 = React47.forwardRef(function DeprecatedTreeView(props, ref) {
  warn25();
  return (0, import_jsx_runtime24.jsx)(TreeView, _extends({}, props, {
    ref
  }));
});
...
var _excluded7 = ["children", "className", "component", "columns", "spacing", "defaultColumns", "defaultHeight", "defaultSpacing"];
...
var Masonry = React48.forwardRef(function Masonry2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiMasonry"
  });
  ...
  const masonryRef = React48.useRef();
  const [maxColumnHeight, setMaxColumnHeight] = React48.useState();
  const isSSR = !maxColumnHeight && defaultHeight && defaultColumns !== void 0 && defaultSpacing !== void 0;
  const [numberOfLineBreaks, setNumberOfLineBreaks] = React48.useState(isSSR ? defaultColumns - 1 : 0);
  const ownerState = _extends({}, props, {
    spacing,
    columns,
    maxColumnHeight,
...
true ? Masonry.propTypes = {
   ...
   * The content of the component.
   */
  children: import_prop_types10.default.node.isRequired,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   * @default 4
   */
  columns: import_prop_types10.default.oneOfType([import_prop_types10.default.arrayOf(import_prop_types10.default.oneOfType([import_prop_types10.default.number, import_prop_types10.default.string])), import_prop_types10.default.number, import_prop_types10.default.object, import_prop_types10.default.string]),
  /**
   ...
   */
  defaultColumns: import_prop_types10.default.number,
  /**
   * The default height of the component in px. This is provided for server-side rendering.
   */
  defaultHeight: import_prop_types10.default.number,
  /**
   * The default spacing of the component. Like `spacing`, it is a factor of the theme's spacing. This is provided for server-side rendering.
   */
  defaultSpacing: import_prop_types10.default.number,
  /**
