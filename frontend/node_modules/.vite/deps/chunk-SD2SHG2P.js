...
function useNumberInput(parameters) {
  ...
  const [dirtyValue, setDirtyValue] = React42.useState(value ? String(value) : void 0);
  React42.useEffect(() => {
...
var Option = React46.memo(React46.forwardRef(function Option2(props, forwardedRef) {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SD2SHG2P.js.map
