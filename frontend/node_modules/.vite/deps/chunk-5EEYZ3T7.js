...
var Tabs = React4.forwardRef(function Tabs2(inProps, ref) {
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime4.jsx)(ScrollButtonComponent, _extends({
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime4.jsx)(ScrollButtonComponent, _extends({
      slots: {
  ...
  const indicator = (0, import_jsx_runtime4.jsx)(TabsIndicator, _extends({}, TabIndicatorProps, {
  ...
  const children = React4.Children.map(childrenProp, (child) => {
    ...
    childIndex += 1;
    return React4.cloneElement(child, _extends({
  ...
  return (0, import_jsx_runtime5.jsxs)(TabsRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    as: component
...
//# sourceMappingURL=chunk-5EEYZ3T7.js.map
